...
const REPO_BASE_URL = '/vue-dlib/'

export default defineConfig({
  base: process.env.VERCEL_BUILD ? '/' : REPO_BASE_URL,
  title: 'vue-dlib',
  description: 'vue-dlib doc',
  head: [
    [
      'link',
      {
  ...
  themeConfig: {
    logo: '/logo.png',
    nav: [{ text: '指令', link: '/zh-CN/components/' }],
    ...
    editLink: {
      pattern:
        'https://github.com/njueyupeng/vue-dlib/',
    ...
    footer: {
      ...
      copyright: 'Copyright © 2019-present Yu Peng',
    },
  },
  markdown: {
